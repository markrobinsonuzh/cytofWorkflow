...
plot_clustering_heatmap_wrapper2 <- function(expr, expr01,
  ...
  ht1 <- Heatmap(expr_heat, 
    name = "Median of the arcsinh,\n0-1 transformed\nmarker expression", 
