...
download.file(file.path(url, merging_table2), destfile = merging_table2, mode = "wb")
...
# [diffcyt::topTable displaying medians is in progress; 
# Lukas says he should finish it today (02.11).]
...
plotDiffHeatmap(daf, ds_res2, top_n = 50, order = TRUE, th = FDR_cutoff, hm1 = FALSE)
```
