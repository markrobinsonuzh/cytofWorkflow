...
There are some options available, such as normalization using bead standards [@Finck2013], equalization of the dynamic range between batches for each marker or usage of warping functions that eliminate non-linear distortions, see `r Githubpkg("MarioniLab/cydar")` vignette. However, a comprehensive evaluation of these approaches and their effect on subsequent analyses is still missing. 
