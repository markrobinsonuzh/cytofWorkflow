...
To keep the analysis of this workflow reproducible, one needs to define a random seed when running `r Biocpkg("FlowSOM")` and UMAP.  This is especially important in the clustering step, where the order of clusters may change with different seeds, and the cluster merging needs to be matched to the seed used.
