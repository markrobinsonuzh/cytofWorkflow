...
In this workflow, we have presented a pipeline for CyTOF data analysis which consists of a quality control step where characteristics of the different samples are visualized, for example, with the MDS plot, allowing verification of the experimental design, detection of batches and outlying samples. 
Next, the cell population identification was carried out, which was a basis for the subsequent differential analyses of cell population abundance, marker expression in each of the populations and overall marker expression.
