...
```{r plot-number-of-cells, fig.cap = paste(ifelse(on.bioc, "**Figure 2.**", ""), "Barplot with the number of cells assayed in each sample, 8 unstimulated (Ref) and 8 stimulated with BCR/FcR-XL (BCRXL) for each of the donors in the PBMC dataset. Bars are colored by experimental condition. Numbers in the names on the x-axis indicate patient IDs. Numbers on top of the bars indicate the cell counts.", " ")}
