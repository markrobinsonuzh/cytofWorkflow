...
As before, we create a summary table displaying the results (raw and adjusted p-values) together with the observed median marker expression in each sample, and plot a heatmap with the markers sorted according to adjusted p-value (Figure \@ref(fig:diff-expr1-plot-heatmap-with-significant-markers)).
